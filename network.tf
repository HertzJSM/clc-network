...
## Cria a subnet publica na us-east-1b
...
## Cria a tabela de rota da subnet publica 1b
...
## Cria um ip publico para o primeiro nat-gateway
resource "aws_eip" "nat_gw_ip_1a" {
  domain = "vpc"
}

## Cria o NAT Gateway na us-east-1a
...
## Cria um ip publico para o segundo nat-gateway
resource "aws_eip" "nat_gw_ip_1b" {
  domain = "vpc"
}

## Cria o NAT Gateway na us-east-1b
...
resource "aws_flow_log" "example" {
  log_destination      = "arn:aws:s3:::hertz-clc13-network-terraform-state"
